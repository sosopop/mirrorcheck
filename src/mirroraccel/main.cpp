...
// Set the default logger to file logger
    ...
    int port = mirror_accel_create("0.0.0.0:7777",
                                   ...
                                   //"},"
                                    "{"
                                    "\"url\":\"http://www.google.com/xszr.mp4?id=1\""
                                    "},"
                                   "{"
                                   "\"url\":\"http://www.google.com/xszr.mp4?id=2\""
                                   "},"
                                   "{"
                                   "\"url\":\"http://www.google.com/xszr.mp4?id=3\""
                                   "},"
                                   "{"
                                   "\"url\":\"http://www.google.com/xszr.mp4?id=4\""
                                   "},"
                                   "{"
                                   "\"url\":\"http://www.google.com/xszr.mp4?id=5\""
                                   "},"
                                   "{"
                                   "\"url\":\"http://www.google.com/xszr.mp4?id=6\""
                                   "},"
                                   "{"
                                   "\"url\":\"http://127.0.0.1:12345/xszr.mp4?id=7\""
                                   "},"
                                   "{"
                                   "\"url\":\"http://42.51.202.14/xszr.mp4?id=8\""
                                   "}"
                                   "]"
                                   "}");
    if (port > 0)
